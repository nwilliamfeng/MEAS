...
namespace MEAS.Data
{
    public class TorqueWrenchProductMap : EntityTypeConfiguration<TorqueWrenchProduct>
    {
        public TorqueWrenchProductMap()
        {
            ...
            Property(x => x.MinRange).HasColumnOrder(4).IsRequired();
            Property(x => x.MaxRange).HasColumnOrder(5).IsRequired();
            Property(x => x.WorkDirection).HasColumnOrder(6).IsRequired();
